...
namespace mml {
  ...
  class type_checker: public basic_ast_visitor {
    ...
    std::stack<std::shared_ptr<cdk::basic_type>> _functionTypeR;
  ...
  protected:
    void do_SubAddExpressions(cdk::binary_operation_node *const node, int lvl);
    void processUnaryExpression(cdk::unary_operation_node *const node, int lvl);
    void processBinaryExpression(cdk::binary_operation_node *const node, int lvl);
    void do_MulDivExpressions(cdk::binary_operation_node *const node, int lvl);
    template<typename T>
